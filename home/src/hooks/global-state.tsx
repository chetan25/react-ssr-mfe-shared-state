...
export const GlobalContextDispatch = createContext<Dispatch<Record<string, any>>>(() => {});
...
export const StoreProvider = ({
    ...
    const [store, dispatch] = useReducer((state: HomeGlobalState, action: Record<string, string>) => {
        switch(action.type) {
             case 'increment':
                return {
                    ...state,
...
export const useGlobalStore = (): [SharedContextType, Dispatch<SharedContextType>] => {
    const [globalUser, updateGlobalUser] = useContext(SharedContext) as [SharedContextType, Dispatch<SharedContextType>];
